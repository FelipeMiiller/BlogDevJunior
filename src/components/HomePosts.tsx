...
export function HomePosts() {
  ...
  return (
    <>
      <div className={" flex  flex-col w-full   h-[calc(100%_-_4rem)] overflow-y-auto " +
          " bg-black"
        }
      >
        <main className={"flex flex-1 justify-center h-auto" + " "}>
          ...
          {data?.posts.map((post) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={"row-span-1 col-span-2  mt-1 " + " text-white "}
                >
                  <Link to={`post/${post.slug}`}>
                    <h2
                      className={
