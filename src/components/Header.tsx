 ...
 //console.log(data)
  ...
  return (
    <>
      <header
        className={
          " w-full h-20 py-5 flex justify-between " +
      ...
      >
        <div>
          <Link to="/">
            <h1
              className={
                "text-2xl font-medium  font-roboto  hover:font-bold" +
                " pl-4  "
              }
            >
              Developer Blog
        ...
        <nav className=" flex justify-around  pr-20">
          <ul className={"flex flex-row  space-x-4 "}>
            <li>
              <button ref={reference} onClick={()=> setOpen(!open)}>Posts</button>
              {open && (
                <div ref={floating} 
               ...
               return(
                ...
                className={"text-sm py-2 px-4 font-normal block w-full whitespace-no-wrap   text-white" 
